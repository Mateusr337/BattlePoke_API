...
describe("POST /users", function () {
    it("should answer with status code 409", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user;
        return __generator(this, function (_a) {
            user = __assign(__assign({ id: 1 }, userFactory.createUserInsertData()), { level: "0" });
            ...
            expect(function () { return __awaiter(void 0, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, userService.create(user)];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
...
describe("function findById", function () {
    it("should answer with status code 409", function () { return __awaiter(void 0, void 0, void 0, function () {
        var user, spy;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, userService.findById(user.id)];
                case 2:
                    _a.sent();
