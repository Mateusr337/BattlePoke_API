...
userRouter.post("/users/validToken", ensureAuthenticatedMiddleware, userController.responseToken);
userRouter.post("/users/login", validateSchemaMiddleware(authSchema), userController.valid);
userRouter.patch("/users/upLevels", ensureAuthenticatedMiddleware, userController.updateLevel);
